...
import "./chat-group-header.scss";
function ChatGroupHeader() {
  return (
    <div className="p-2 ChatGroupHeader">
      <div className="flex flex-row items-center ml-5">
        <svg width="20" height="20" viewBox="0 0 24 24" className="icon">
          <path
            fill="currentColor"
            fill-rule="evenodd"
            clip-rule="evenodd"
        ...
        <span className="ml-2 text-lg font-bold text-white">tess</span>
      </div>
      <div className="flex flex-row">
        ...
        <div className="relative flex flex-row items-center ml-4">
